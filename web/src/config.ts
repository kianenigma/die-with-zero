...
export const TOOLTIPS: Record<string, string> = {
	...
	yearlyBreakdown: "Year 0 represents your starting point (no savings or gains yet). From year 1 onwards, each asset column shows the current value with a simplified breakdown: ↑ (green arrow) shows total gains (sum of organic growth, savings contributions, and incoming transfers), ↓ (red arrow) shows total losses (sum of liquidations for expenses and outgoing transfers). Hover over the 'i' icon next to the arrows to see the detailed breakdown of where gains or losses come from. Total Net Worth shows the net change (green/red ↑/↓) from the previous year.",
